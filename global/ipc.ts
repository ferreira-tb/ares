...
export async function ipcInvoke(channel: 'deimos-endpoint'): Promise<string>;
export async function ipcInvoke(channel: 'deimos-can-predict-plunder', world?: string): Promise<boolean>;
