...
export function assertFarmUnit(unit: unknown, SomeError: typeof AresError, message?: string): asserts unit is FarmUnits {
...
export function assertUserAlias(alias: unknown, SomeError: typeof AresError, message?: string): asserts alias is UserAlias {
...
export function assertWorld(world: unknown, SomeError: typeof AresError, message?: string): asserts world is World {
...
export function assertWallLevel(level: unknown, SomeError: typeof AresError, message?: string): asserts level is WallLevel {
...
export function assertDistance(distance: unknown, SomeError: typeof AresError, message?: string): asserts distance is number {
